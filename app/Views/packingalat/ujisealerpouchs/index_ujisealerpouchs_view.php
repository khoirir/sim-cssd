...
<section class="content">
    <div class="container-fluid">
        <div class="col-md-10">
            <form action="<?= site_url('/uji-sealer-pouchs/data-uji-sealer-pouchs'); ?>" method="POST" id="formFilterData">
                <?= csrf_field(); ?>
        ...
        <div class="col-md-10">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h3 class="card-title">Uji Sealer Pouchs</h3>
                </div>
                <div class="card-body">
                    <table class="table table-sm table-border-head table-hover" id="tabelUjiSealerPouchs">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th scope="col" rowspan="2" class="text-center align-middle">Suhu Mesin 200</th>
                                <th scope="col" rowspan="2" class="text-center align-middle">Speed Sedang</th>
                                ...
                                <th scope="col" rowspan="2" class="text-center align-middle">Gambar Uji Sealer</th>
                                <th scope="col" rowspan="2" class="text-center align-middle">Aksi</th>
                            </tr>
                            <tr>
                                <th scope="col" class="text-center align-middle">Bocor</th>
                                <th scope="col" class="text-center align-middle">Tidak</th>
                            </tr>
                        </thead>
                        <tbody>
                        </tbody>
                ...
                <div class="card-footer">
                    <a class="btn btn-primary float-right" href="<?= base_url('/uji-sealer-pouchs/tambah'); ?>">

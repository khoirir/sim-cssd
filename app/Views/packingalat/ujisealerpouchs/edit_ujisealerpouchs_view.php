        ...
        <div class="col-lg-6">
            ...
            <div class="card card-warning card-outline">
                <div class="card-header">
                    <h3 class="card-title">Edit Uji Sealer Pouchs / <?= generateNoReferensi($dataUjiSealerPouchsBerdasarkanId['created_at'], $dataUjiSealerPouchsBerdasarkanId['id']); ?></h3>
                </div>
                <form action="<?= base_url('/uji-sealer-pouchs/update/' . $dataUjiSealerPouchsBerdasarkanId['id']); ?>" method="POST" enctype="multipart/form-data" id="formUjiSealerPouchs">
                    <?= csrf_field(); ?>
                    <div class="card-body">
                        <fieldset class="content-group">
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" name="tanggalUji" id="tanggalUji" value="<?= $dataUjiSealerPouchsBerdasarkanId['tanggal_uji']; ?>">
                                ...
                                <div class="form-group mb-0" id="divPetugas">
                                    <select class="form-control select2" style="width: 100%;" data-placeholder="Pilih Petugas" name="petugas" id="petugas">
                                        ...
                                        <?php foreach ($listPegawaiCSSD as $pegawai) : ?>
                                            <option value="<?= $pegawai['nik']; ?>" <?= ($dataUjiSealerPouchsBerdasarkanId['id_petugas']) == $pegawai['nik'] ? 'selected' : ''; ?>><?= $pegawai['nama']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="icheck-primary">
                                    <input type="checkbox" id="checkboxSuhuMesin" name="checkboxSuhuMesin" value="checked" class="form-check-input" <?= $dataUjiSealerPouchsBerdasarkanId['suhu_mesin_200']; ?>>
                            ...
                            <div class="form-group">
                                <div class="icheck-primary">
                                    <input type="checkbox" id="checkboxSpeedSedang" name="checkboxSpeedSedang" value="checked" class="form-check-input" <?= $dataUjiSealerPouchsBerdasarkanId['speed_sedang']; ?>>
                            ...
                            <div class="form-group">
                                ...
                                <div class="icheck-primary d-inline mr-5">
                                    <input type="radio" id="radioBocor" value="bocor" name="radioHasilUji" class="form-radio-input" <?= ($dataUjiSealerPouchsBerdasarkanId['hasil_uji'] == 'bocor') ? 'checked' : ''; ?>>
                                    <label for="radioBocor" class="form-check-label radio-label">
                                        Bocor
                                    </label>
                                </div>
                                <div class="icheck-primary d-inline">
                                    <input type="radio" id="radioTidak" value="tidak" name="radioHasilUji" class="form-radio-input" <?= ($dataUjiSealerPouchsBerdasarkanId['hasil_uji'] == 'tidak') ? 'checked' : ''; ?>>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" rows="2" name="keterangan" id="keterangan"><?= $dataUjiSealerPouchsBerdasarkanId['keterangan']; ?></textarea>
                            </div>
                        </fieldset>
                    </div>

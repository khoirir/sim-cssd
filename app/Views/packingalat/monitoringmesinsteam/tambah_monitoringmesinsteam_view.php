                    ...
                    <div class="col-lg-4">
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h3 class="card-title">Tambah Monitoring Mesin Steam</h3>
                            </div>
                            <div class="card-body">
                                <fieldset class="content-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="icheck-primary d-inline mr-3">
                                            <input type="radio" id="radioGetinge" value="Getinge" name="mesin" class="form-radio-input">
                                            <label for="radioGetinge" class="form-check-label radio-label">
                                                Getinge
                                            </label>
                                        </div>
                                        <div class="icheck-primary d-inline mr-3">
                                            <input type="radio" id="radioSakura" value="Sakura" name="mesin" class="form-radio-input">
                                            <label for="radioSakura" class="form-check-label radio-label">
                                                Sakura
                                            </label>
                                        </div>
                                        <div class="icheck-primary d-inline">
                                            <input type="radio" id="radioNouva" value="Nouva" name="mesin" class="form-radio-input">

...
<section class="content">
    <div class="container-fluid">
        <div class="col-lg-12">
            <form action="<?= site_url('/monitoring-mesin-steam/data-monitoring-mesin-steam-berdasarkan-tanggal'); ?>" method="POST" id="formFilterData">
                <?= csrf_field(); ?>
        ...
        <div class="col-lg-12">
            <div class="card card-primary card-outline">
                <div class="card-header d-flex p-0">
                    <h3 class="card-title p-3">Monitoring Mesin Steam</h3>
                </div>
                <div class="card-body">
                    <table class="table table-sm table-border-head table-hover" id="tabelMonitoringMesinSteam">
                        <thead class="thead-light" style="pointer-events: none;">
                            ...
                            <th scope="col" class="text-center align-middle">Mesin</th>
                ...
                <div class="card-footer">
                    <a class="btn btn-primary float-right" href="<?= base_url('/monitoring-mesin-steam/tambah'); ?>">

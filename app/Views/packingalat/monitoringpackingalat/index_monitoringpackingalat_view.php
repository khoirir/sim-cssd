...
<section class="content">
    <div class="container-fluid">
        <div class="col-md-8">
            <form action="<?= site_url('/monitoring-packing-alat/data-berdasarkan-tanggal'); ?>" method="POST" id="formFilterData">
                <?= csrf_field(); ?>
        ...
        <div class="col-lg-8">
            <div class="card card-primary card-outline">
                <div class="card-header d-flex p-0">
                    <h3 class="card-title p-3">Monitoring Packing Alat</h3>
                </div>
                <div class="card-body">
                    <table class="table table-sm table-border-head table-hover" id="tabelMonitoringPackingAlat">
                ...
                <div class="card-footer">
                    <a class="btn btn-primary float-right" href="<?= base_url('/monitoring-packing-alat/tambah'); ?>">

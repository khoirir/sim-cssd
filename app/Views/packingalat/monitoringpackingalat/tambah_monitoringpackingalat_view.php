...
<section class="content">
    <div class="container-fluid">
        <div class="col-lg-12">
            ...
            <form action="<?= base_url('/monitoring-packing-alat/simpan'); ?>" method="POST" id="formPackingAlat">
                <?= csrf_field(); ?>
                <div class="form-row">
                    <div class="col-lg-4">
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h3 class="card-title">Tambah Monitoring Packing Alat</h3>
                            </div>
                            <div class="card-body">
                                <fieldset class="content-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="tanggalPacking" id="tanggalPacking" value="<?= $tglSekarang; ?>">
                                    ...
                                    <div class="form-group">
                                        <div class="table-responsive">
                                            <table class="table table-sm table-hover table-border-head mb-0" id="tabelDataAlat" name="tabelDataAlat">
                                                ...
                                                <tfoot>
                                                    <td colspan="7" class="text-center align-middle data-kosong">DATA TIDAK ADA</td>
                                                </tfoot>
                                            </table>
...
<!-- /.content -->
<script src="<?= base_url(); ?>/js/packingalat/monitoringpackingalat/proses_tambah_edit_monitoringpackingalat.js"></script>
<?= $this->endSection(); ?>
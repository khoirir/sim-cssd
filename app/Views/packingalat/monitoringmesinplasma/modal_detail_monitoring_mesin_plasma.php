<div class="modal fade" id="modalDetailMonitoringMesinPlasma">
    <?php
    if ($dataVerifikasi) {
        ...
        $dataPrint = '/public/img/monitoringmesinplasma/' . $dataVerifikasi['data_print'];
        $indikatorEksternal = '/public/img/monitoringmesinplasma/' . $dataVerifikasi['indikator_eksternal'];
        $indikatorInternal = '/public/img/monitoringmesinplasma/' . $dataVerifikasi['indikator_internal'];
        $indikatorBiologi = '/public/img/monitoringmesinplasma/' . $dataVerifikasi['indikator_biologi'];
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content" style="border-top: #17A2B8 3px solid;">
            <div class="modal-header">
                <h6 class="modal-title">Detail Monitoring Mesin Plasma /
                    <?php
                    echo generateNoReferensi($dataMesinPlasma['created_at'], $dataMesinPlasma['id']);
                    if ($dataMesinPlasma['proses_ulang']) {
                        echo " / Proses Ulang dari " . generateNoReferensi($dataMesinPlasma['created_proses_ulang'], $dataMesinPlasma['proses_ulang']);
                    }
                    ?>
                </h6>

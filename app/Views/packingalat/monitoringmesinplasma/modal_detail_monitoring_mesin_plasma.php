<div class="modal fade" id="modalDetailMonitoringMesinPlasma">
    ...
    if ($dataVerifikasi) {
        ...
        $dataPrint = '/img/monitoringmesinplasma/' . $dataVerifikasi['data_print'];
        $indikatorEksternal = '/img/monitoringmesinplasma/' . $dataVerifikasi['indikator_eksternal'];
        $indikatorInternal = '/img/monitoringmesinplasma/' . $dataVerifikasi['indikator_internal'];
        $indikatorBiologi = '/img/monitoringmesinplasma/' . $dataVerifikasi['indikator_biologi'];

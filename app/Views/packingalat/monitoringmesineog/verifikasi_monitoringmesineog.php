                ...
                <div class="col-lg-8">
                    <div class="card card-primary card-outline">
                        ...
                        if ($dataVerifikasi) {
                            ...
                            $dataPrint = base_url('/public/img/monitoringmesineog/' . $dataVerifikasi['data_print']);
                            $displayPreviewIndikatorEksternal = 'block';
                            $indikatorEksternal = base_url('/public/img/monitoringmesineog/' . $dataVerifikasi['indikator_eksternal']);
                            $displayPreviewIndikatorInternal = 'block';
                            $indikatorInternal = base_url('/public/img/monitoringmesineog/' . $dataVerifikasi['indikator_internal']);
                            $displayPreviewIndikatorBiologi = 'block';
                            $indikatorBiologi = base_url('/public/img/monitoringmesineog/' . $dataVerifikasi['indikator_biologi']);

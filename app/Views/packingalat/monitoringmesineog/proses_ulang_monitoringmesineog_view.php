...
<section class="content">
    <div class="container-fluid">
        <div class="col-lg-12">
            ...
            <form action="<?= base_url('/monitoring-mesin-eog/simpan'); ?>" method="POST" enctype="multipart/form-data" id="formMonitoringMesinEog">
                <?= csrf_field(); ?>
                <div class="form-row">
                    <div class="col-lg-4">
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h3 class="card-title">Proses Ulang dari <?= generateNoReferensi($dataMesinEog['created_at'], $dataMesinEog['id']); ?></h3>
                            </div>
                            <div class="card-body">
                                <fieldset class="content-group">
                                    <legend class="text-bold">Siklus & Operator</legend>
                                    <div class="form-group">
                                        <input type="hidden" name="prosesUlang" id="prosesUlang" value="<?= $dataMesinEog['id']; ?>">

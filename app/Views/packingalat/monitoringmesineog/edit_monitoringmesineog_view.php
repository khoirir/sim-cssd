...
<section class="content">
    <div class="container-fluid">
        <div class="col-lg-12">
            ...
            <form action="<?= base_url('/monitoring-mesin-eog/update/' . $dataMesinEog['id']); ?>" method="POST" enctype="multipart/form-data" id="formMonitoringMesinEog">
                <?= csrf_field(); ?>
                <div class="form-row">
                    <div class="col-lg-4">
                        <div class="card card-warning card-outline">
                            <div class="card-header">
                                <h3 class="card-title">Edit Monitoring Mesin EOG / <?= generateNoReferensi($dataMesinEog['created_at'], $dataMesinEog['id']); ?></h3>
                            </div>
                            <div class="card-body">
                                <fieldset class="content-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="tanggalMonitoring" id="tanggalMonitoring" value="<?= date('Y-m-d', strtotime($dataMesinEog['tanggal_monitoring'])); ?>">
                                        <div class="invalid-feedback" id="invalidTanggalMonitoring"></div>
                                    </div>
                                    <div class="form-group">
                                        <label for="jamMasukAlat">Jam Masuk Alat</label>
                                        <input type="time" class="form-control" name="jamMasukAlat" id="jamMasukAlat" value="<?= date('H:i', strtotime($dataMesinEog['tanggal_monitoring'])); ?>">
                                        <div class="invalid-feedback" id="invalidJamMasukAlat"></div>
                                    </div>
                                    <div class="form-group">
                                        <label for="siklus">Siklus</label>
                                        <input class="form-control" name="siklus" id="siklus" type="text" inputmode="numeric" oninput="this.value = this.value.replace(/[^0-9]/g, '')" title="Input harus berupa angka" value="<?= $dataMesinEog['siklus']; ?>">
                                        <div class="invalid-feedback mt-2" id="invalidSiklus"></div>
                                    </div>
                                    <div class="form-group">
                                        <label class="d-flex mb-3">Shift</label>
                                        <div class="icheck-primary d-inline mr-3">
                                            <input type="radio" id="radioShiftPagi" value="pagi" name="shift" <?= ($dataMesinEog['shift'] == 'pagi') ? 'checked' : ''; ?> class="form-radio-input">
                                            <label for="radioShiftPagi" class="form-check-label radio-label">
                                                Pagi
                                            </label>
                                        </div>
                                        <div class="icheck-primary d-inline">
                                            <input type="radio" id="radioShiftSore" value="sore" name="shift" <?= ($dataMesinEog['shift'] == 'sore') ? 'checked' : ''; ?> class="form-radio-input">

...
<section class="content">
    <div class="container-fluid">
        <div class="col-lg-12">
            <form action="<?= site_url('/monitoring-mesin-eog/data-monitoring-mesin-eog-berdasarkan-tanggal'); ?>" method="POST" id="formFilterData">
                <?= csrf_field(); ?>
        ...
        <div class="col-lg-12">
            <div class="card card-primary card-outline">
                <div class="card-header d-flex p-0">
                    <h3 class="card-title p-3">Monitoring Mesin EOG</h3>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-sm table-border-head table-hover" id="tabelMonitoringMesinEog">
                ...
                <div class="card-footer">
                    <a class="btn btn-primary float-right" href="<?= base_url('/monitoring-mesin-eog/tambah'); ?>">
...
<script src="<?= base_url(); ?>/js/packingalat/monitoringmesineog/index_monitoringmesineog.js"></script>
<?= $this->endSection(); ?>
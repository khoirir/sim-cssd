    ...
    <div class="container-fluid">
        <div class="col-lg-7">
            ...
            <div class="card card-outline card-warning">
                ...
                <form action="<?= base_url('/suhu-dan-kelembapan/update/' . $dataSuhuKelembapanBerdasarkanId['id']); ?>" method="POST" id="formSuhuKelembapan">
                    <?= csrf_field(); ?>
                    <div class="card-body">
...
<!-- /.content -->
<script src="<?= base_url(); ?>/js/distribusi/suhudankelembapan/proses_tambah_edit_suhudankelembapan.js"></script>
<?= $this->endSection(); ?>
...
<section class="content">
    <div class="container-fluid">
        <div class="col-md-8">
            <form action="<?= site_url('suhu-dan-kelembapan/suhu-kelembapan-berdasarkan-tanggal'); ?>" method="POST" id="formFilterData">
                <?= csrf_field(); ?>
        ...
        <div class="col-lg-8">
            <div class="card card-primary card-outline">
                ...
                <div class="card-footer">
                    <a class="btn btn-info" href="<?= base_url('/suhu-dan-kelembapan/grafik'); ?>">
                        <i class="far fa-chart-bar mr-2"></i> Lihat Grafik
                    </a>
                    <a class="btn btn-primary float-right" href="<?= base_url('/suhu-dan-kelembapan/tambah'); ?>">

...
<section class="content">
    <div class="container-fluid">
        <div class="col-md-10">
            <form action="<?= site_url('/permintaan-alat-steril/data-permintaan-alat-steril'); ?>" method="POST" id="formFilterData">
                <?= csrf_field(); ?>
        ...
        <div class="col-lg-10">
            <div class="card card-primary card-outline">
                <div class="card-header d-flex p-0">
                    <h3 class="card-title p-3">Permintaan Alat Steril</h3>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-sm table-border-head table-hover" id="tabelPermintaanAlatSteril">
                ...
                <div class="card-footer">
                    <a href="<?= base_url('/permintaan-alat-steril/tambah'); ?>" class="btn btn-primary float-right">

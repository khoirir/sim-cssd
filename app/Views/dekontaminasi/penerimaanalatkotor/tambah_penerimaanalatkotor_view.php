...
<section class="content">
    <div class="container-fluid">
        <div class="col-lg-12">
            ...
            <form action="<?= base_url('/penerimaan-alat-kotor/simpan'); ?>" method="POST" id="formPenerimaanAlatKotor">
                <?= csrf_field(); ?>
                <div class="form-row">
                    <div class="col-lg-4">
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h3 class="card-title">Tambah Penerimaan Alat Kotor</h3>
                            </div>
                            <div class="card-body">
                                <fieldset class="content-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="tanggalPenerimaan" id="tanggalPenerimaan" value="<?= $tglSekarang; ?>">
                                        <div class="invalid-feedback" id="invalidTanggalPenerimaan"></div>
                                    </div>
                                    <div class="form-group">
                                        <label for="jamPenerimaan">Jam</label>
                                        <input type="time" class="form-control" name="jamPenerimaan" id="jamPenerimaan" value="<?= $jamSekarang; ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group mb-0" id="divPetugasPenyetor">
                                            <select class="form-control select2" style="width: 100%;" data-placeholder="Pilih Petugas Penyetor" name="petugasPenyetor" id="petugasPenyetor">
                                                ...
                                                ?>
                                                        <option id="pegawaiPenyetorOption<?= $pegawai['nik']; ?>" value="<?= $pegawai['nik']; ?>"><?= $pegawai['nama']; ?></option>
                                                <?php
                                                    endif;
                                                endforeach;
                                                ?>
...
<!-- /.content -->
<script src="<?= base_url(); ?>/js/dekontaminasi/penerimaanalatkotor/proses_tambah_edit_penerimaanalatkotor.js"></script>
<?= $this->endSection(); ?>
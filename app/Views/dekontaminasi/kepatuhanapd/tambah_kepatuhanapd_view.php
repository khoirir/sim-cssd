...
<section class="content">
    <div class="container-fluid">
        <div class="col-lg-12">
            ...
            <form action="<?= base_url('/kepatuhan-apd/simpan'); ?>" method="POST" id="formApd">
                <?= csrf_field(); ?>
                <div class="form-row">
                    <div class="col-lg-4">
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h3 class="card-title">Tambah Kepatuhan APD</h3>
                            </div>
                            <div class="card-body">
                                    ...
                                    <div class="row justify-content-between">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" name="tanggalCek" id="tanggalCek" value="<?= $tglSekarang; ?>">

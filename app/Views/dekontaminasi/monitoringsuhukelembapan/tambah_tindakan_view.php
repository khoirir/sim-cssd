    ...
    <div class="container-fluid">
        <div class="col-lg-6">
            ...
            <div class="card card-outline card-primary">
                ...
                <form action="<?= base_url('/monitoring-suhu-kelembapan/simpan-tindakan/' . $idSuhuKelembapan); ?>" method="POST" id="formHasilTindakan">
                    <?= csrf_field(); ?>
                    <div class="card-body">
                ...
                <div class="card-footer">
                    <div class="<?= $hasilTindakan ? 'd-flex justify-content-between' : ''; ?>">
                        <?php if ($hasilTindakan) : ?>
                            <form action="<?= base_url('/monitoring-suhu-kelembapan/hapus-tindakan/' . $idSuhuKelembapan); ?>" method="POST" id="formHapusTindakan">
                                <?= csrf_field(); ?>
...
<!-- /.content -->
<script src="<?= base_url(); ?>public/js/dekontaminasi/monitoringsuhukelembapan/tindakan_monitoringsuhukelembapan.js"></script>
<?= $this->endSection(); ?>
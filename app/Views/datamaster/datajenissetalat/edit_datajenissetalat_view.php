        ...
        <div class="col-lg-6">
            ...
            <div class="card card-outline card-warning">
                <div class="card-header">
                    <h3 class="card-title">Edit Data Jenis Set Alat</h3>
                </div>

                <form action="<?= base_url('/data-jenis-set-alat/update/'.$dataJenis['id']); ?>" method="POST" id="formDataJenisSetAlat">
                    <?= csrf_field(); ?>
                    <div class="card-body">
                        <fieldset class="content-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="namaJenis" id="namaJenis" value="<?= $dataJenis['nama_jenis']; ?>">

        ...
        <div class="col-lg-6">
            ...
            <div class="card card-outline card-primary">
                <div class="card-header">
                    <h3 class="card-title">Tambah Data Set Alat</h3>
                </div>

                <form action="<?= base_url('/data-set-alat/simpan'); ?>" method="POST" id="formDataSetAlat">
                    <?= csrf_field(); ?>
                    <div class="card-body">
                        <fieldset class="content-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="namaSetAlat" id="namaSetAlat">
...
<!-- /.content -->
<script src="<?= base_url(); ?>/js/datamaster/datasetalat/proses_tambah_edit_datasetalat.js"></script>
<?= $this->endSection(); ?>
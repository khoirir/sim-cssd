        ...
        <div class="col-lg-8">
            <div class="card card-primary card-outline">
                <div class="card-header d-flex p-0">
                    <h3 class="card-title p-3">Data BMHP</h3>
                </div>
                <div class="card-body">
                    <table class="table table-sm table-border-head table-hover" id="tabelDataBmhp">
                        <thead class="thead-light" style="pointer-events: none;">
                            ...
                            <th scope="col" class="text-center align-middle" style="width:20%;">Harga</th>
                ...
                <div class="card-footer">
                    <a class="btn btn-primary float-right" href="<?= base_url('/data-bmhp/tambah'); ?>">
...
<script src="<?= base_url(); ?>/js/datamaster/databmhp/index_databmhp.js"></script>
<?= $this->endSection(); ?>
...
-- ----------------------------
-- Table structure for cssd_monitoring_mesin_plasma
-- ----------------------------
DROP TABLE IF EXISTS `cssd_monitoring_mesin_plasma`;
CREATE TABLE `cssd_monitoring_mesin_plasma`  (
...
-- ----------------------------
-- Records of cssd_monitoring_mesin_plasma
-- ----------------------------

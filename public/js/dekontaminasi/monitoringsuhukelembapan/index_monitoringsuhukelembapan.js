$(function () {
    ...
    tampilDataTabelSuhuDanKelembapan();
});

function tampilDataTabelSuhuDanKelembapan() {
...
$('#formFilterData').on('submit', function (e) {
    ...
    if (pesanError.length > 0) {
        ...
        sessionStorage.setItem('monitoringsuhukelembapan', JSON.stringify({ tglAwal: tglAwal, tglAkhir: tglAkhir }));
    }
});

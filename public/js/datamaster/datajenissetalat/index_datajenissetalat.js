$(function () {
    tampilDataJenisSetAlat();
});

function tampilDataJenisSetAlat() {
    $('#tabelDataJenisSetAlat').DataTable(
        {
            bDestroy: true,
            processing: true,
            serverSide: true,
...
$('#tabelDataJenisSetAlat tbody').on("click", ".formHapus button[type='submit']", function (e) {
    e.preventDefault();
    swalDelete.fire({
        title: 'Hapus Jenis Set Alat',
                ...
                success: function (res) {
                    ...
                    if (res.sukses) {
                        swalWithBootstrapButtons.fire(
                            ...
                            res.pesan.teks,
                            "success"
                        ).then(() => $('#tabelDataJenisSetAlat').DataTable().ajax.reload(null, false));
                    } else {
                        swalWithBootstrapButtons.fire(
                            res.pesan.judul,
                            res.pesan.teks,

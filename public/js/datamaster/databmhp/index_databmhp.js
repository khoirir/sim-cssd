...
function tampilDataBmhp() {
    $('#tabelDataBmhp').DataTable(
        {
            bDestroy: true,
            processing: true,
            serverSide: true,
            ...
            columns: [
                ...
                },
                {
                    "data": "harga",
                    "orderable": false,
                    "className": "align-middle text-right pr-3"
                },
                {
                    "data": "satuan",
                    "orderable": false,
...
$('#tabelDataBmhp tbody').on("click", ".formHapus button[type='submit']", function (e) {
    e.preventDefault();
    swalDelete.fire({
        title: 'Hapus BMHP',
                ...
                success: function (res) {
                    ...
                    if (res.sukses) {
                        swalWithBootstrapButtons.fire(
                            ...
                            res.pesan.teks,
                            "success"
                        ).then(() => $('#tabelDataBmhp').DataTable().ajax.reload(null, false));
                    } else {
                        swalWithBootstrapButtons.fire(
                            res.pesan.judul,
                            res.pesan.teks,

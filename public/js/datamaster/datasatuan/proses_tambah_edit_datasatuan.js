$('#formDataSatuan').on('submit', function (e) {
    e.preventDefault();
    $.ajax({
        ...
        success: function (res) {
            if (!res.sukses) {
                ...
                if (res.pesan.invalidKodeSatuan) {
                    $('#kodeSatuan').addClass('is-invalid');
                    $('#invalidKodeSatuan').html(res.pesan.invalidKodeSatuan);
                }
                if (res.pesan.invalidNamaSatuan) {
                    $('#namaSatuan').addClass('is-invalid');
                    $('#invalidNamaSatuan').html(res.pesan.invalidNamaSatuan);
                }
